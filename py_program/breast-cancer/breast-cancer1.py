...
import pandas as pd
df_train = pd.read_csv('E:/PythonPackage/csv/breast-cancer-train.csv')#传入训练文件数据存入df_train
df_test = pd.read_csv('E:/PythonPackage/csv/breast-cancer-test.csv')#传入测试文件数据存入df_test
